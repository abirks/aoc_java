...
public class Aoc2023Test {
    ...
    public void testDay02() throws AocLoadException, AocSolveException {
        assertAocDay(new AdventOfCode2023Day02(), "input/aoc2023/input02.txt", "INCOMPLETE", "INCOMPLETE");
    }
    ...
    public void testDay04() throws AocLoadException, AocSolveException {
        assertAocDay(new AdventOfCode2023Day04(), "input/aoc2023/input04.txt", "INCOMPLETE", "INCOMPLETE");
    }
    ...
    public void testDay23() throws AocLoadException, AocSolveException {
        assertAocDay(new AdventOfCode2023Day01(), "input/aoc2023/input23.txt", "INCOMPLETE", "INCOMPLETE");
    }

    @Test
    @AocCoverage(year = 2023, day = 24)
    public void testDay24() throws AocLoadException, AocSolveException {
        assertAocDay(new AdventOfCode2023Day01(), "input/aoc2023/input24.txt", "INCOMPLETE", "INCOMPLETE");
    }

    @Test
    @AocCoverage(year = 2023, day = 25)
    public void testDay25() throws AocLoadException, AocSolveException {
        assertAocDay(new AdventOfCode2023Day01(), "input/aoc2023/input25.txt", "INCOMPLETE", "INCOMPLETE");
    }
